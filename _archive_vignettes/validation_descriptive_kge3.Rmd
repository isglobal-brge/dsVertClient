---
title: "Descriptive statistics validation (K>=3)"
...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Descriptive statistics validation (K>=3)}
...
rows <- row_result(
  ...
  "max(mean_sd_abs_delta)", observed, 1e-10, "strict-precise",
