...
| `ds.vertGLMM` | Signed binary same-owner random-intercept Synopsis moments | Promoted post-processing: population-average log-odds, observed-scale ICC and explicit latent-logit variance approximation | PQL/Laplace/ML/REML, covariates, random slopes, covariance and sampling inference remain unavailable. |
