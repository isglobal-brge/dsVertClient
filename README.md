...
| GEE | Signed finite binomial/Poisson grid or completed formal certificate for independence, or matching signed Gaussian random-intercept Synopsis for exchangeable working GLS | same read-only signed-artifact route | no cluster statistics, robust covariance, standard errors, AR(1) correlation or inference |
