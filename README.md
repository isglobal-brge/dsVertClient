...
| GLMM | Signed binary `outcome ~ 1` population-average log-odds/ICC moment approximation, or additive bare-covariate finite random-intercept/one-to-three-random-slope likelihood grid | same, tested through K=5 | not PQL/Laplace/ML/REML; no interactions, more than three random slopes, covariance, standard errors or sampling inference |
