...
| GLMM | Signed binary `outcome ~ 1` population-average log-odds/ICC moment approximation, or additive bare-covariate finite random-intercept/one-or-two-random-slope likelihood grid | same, tested through K=5 | not PQL/Laplace/ML/REML; no interactions, more than two random slopes, covariance, standard errors or sampling inference |
