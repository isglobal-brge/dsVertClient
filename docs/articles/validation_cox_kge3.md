...
| s3  | s3     |  60 | patient_id, x3, time, event |
...
#> [#D' non-disclosive] K=3 OS=s3 fusion/NL=s1 session=cox_nd_20260506095725_1348692283 target=cox_profile
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.cox(method=‘profile’) | synthetic discretised survival fixture | survival::coxph(ties=‘breslow’) | coef_max_abs_delta | 4.87e-05 | 0.001 | strict-practical | PASS | 122.1 |
