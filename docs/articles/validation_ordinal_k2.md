...
| s2  | s2     |  60 | patient_id, x3, y_ord, low_leq, med_leq, high_leq |
...
#> [OrdinalJointStrict] session ordinalStrict_1778060441_561301485 n=60 p=3 class_counts=[20,20,20]
#> [OrdinalJointStrict eval 1] |g|_inf=6.964e-03
#> [OrdinalJointStrict eval 2] |g|_inf=3.983e-03
#> [OrdinalJointStrict eval 3] |g|_inf=1.333e-03
#> [OrdinalJointStrict eval 4] |g|_inf=6.681e-04
#> [OrdinalJointStrict eval 5] |g|_inf=1.165e-03
#> [OrdinalJointStrict eval 6] |g|_inf=2.529e-04
#> [OrdinalJointStrict eval 7] |g|_inf=1.633e-05
#> [OrdinalJointStrict eval 8] |g|_inf=1.800e-05
#> [OrdinalJointStrict eval 9] |g|_inf=2.065e-05
#> [OrdinalJointStrict eval 10] |g|_inf=1.633e-05
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K=2 | ds.vert.ordinal | balanced synthetic 3-level ordinal fixture | MASS::polr cumulative probabilities | cumulative_probability_max_abs_delta | 1.61e-05 | 0.001 | strict-practical | PASS | 880.7 |
