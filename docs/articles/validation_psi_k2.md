...
|     | server |   n | columns                   |
|:----|:-------|----:|:--------------------------|
| s1  | s1     |  80 | patient_id, id_num, value |
| s2  | s2     |  80 | patient_id, id_num, value |
...
#>   Common records: 70
#> Server 's1': 70 of 80 records matched (87.5%)
#> Server 's2': 70 of 80 records matched (87.5%)
#> PSI alignment complete.
#> === Ring63 Correlation (p=2, 2 servers) ===
#> [Phase 0] Transport keys...
#> [Phase 1] Standardizing...
#> [Phase 2] Local correlations...
#> [Phase 3] Input sharing...
#> [Phase 4] Beaver cross-products (2 columns)...
#>   Column 1/2 done
#>   Column 2/2 done
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K=2 | ds.vert.align | synthetic ID intersection | deterministic set intersection | max(count_delta, correlation_delta) | 0 | 0 | strict-precise | PASS | 2 |
