...
#>   [Input Sharing] Complete (p_total=7, 0.3s)
...
#>   Iter 11: ||grad||=0.0006, step=1.00, diff=3.49e-04, theta=[0.000, 0.342] (0.2s)
#>   Iter 12: ||grad||=0.0002, step=1.00, diff=1.41e-04, theta=[0.000, 0.342] (0.2s)
#>   Iter 13: ||grad||=0.0002, step=1.00, diff=4.86e-05, theta=[0.000, 0.342] (0.3s)
#>   Converged after 13 iterations (diff = 4.86e-05)
#>   [Ring63-DCF-Beaver] Converged after 13 iters (total 3.0s)
...
#>   (Intercept)        -1.2306     0.3666     -3.356   0.000789 ***
#>   age                 0.0118     0.0054      2.181   0.029213 *
#>   bmi                 0.0034     0.0098      0.349   0.726759
#>   ped                 0.3141     0.1181      2.660   0.007821 **
#>   skin                0.0070     0.0061      1.136   0.255858
#>   npreg               0.0108     0.0199      0.543   0.586860
#>   glu                 0.0047     0.0015      3.075   0.002104 **
#>   bp                  0.0014     0.0045      0.317   0.751567
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.lasso_proximal(lambda=0) | MASS::Pima.tr fixture | OLS limit of ds.vert.glm | lambda0_coef_abs_delta | 0 | 0 | strict-precise | PASS | 9.3 |
