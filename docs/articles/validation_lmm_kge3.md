...
| s3  | s3     |  60 | patient_id, x3, y, cluster |
...
#> [ds.vertLMM.k3] Querying cluster sizes ...
#> [ds.vertLMM.k3] golden-section over rho in [0.001, 0.999] ...
#> [ds.vertLMM.k3] inner fit at rho=0.3822
#> [ds.vertLMM.k3] inner fit at rho=0.6178
#> [ds.vertLMM.k3] inner fit at rho=0.7634
#>   it=1  rho in [0.3822, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.8534
#>   it=2  rho in [0.6178, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9090
#>   it=3  rho in [0.7634, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9434
#>   it=4  rho in [0.8534, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9646
#>   it=5  rho in [0.9090, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9778
#>   it=6  rho in [0.9434, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9859
#>   it=7  rho in [0.9646, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9909
#>   it=8  rho in [0.9778, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9940
#>   it=9  rho in [0.9859, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9959
#>   it=10  rho in [0.9909, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9971
#>   it=11  rho in [0.9940, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9978
#>   it=12  rho in [0.9959, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9983
#>   it=13  rho in [0.9971, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9985
#>   it=14  rho in [0.9978, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9987
#>   it=15  rho in [0.9983, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9988
#>   it=16  rho in [0.9985, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9989
#>   it=17  rho in [0.9987, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9989
#>   it=18  rho in [0.9988, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9990
#>   it=19  rho in [0.9989, 0.9990]
#> [ds.vertLMM.k3] inner fit at rho=0.9990
#>   it=20  rho in [0.9989, 0.9990]
#> [ds.vertLMM.k3] within-between ANOVA on y for variance components (Pinheiro-Bates 2000 sec.2.4.2) ...
#> [ds.vertLMM.k3] X-correction for sigma^2: summing per-server beta_s' Var_within(X_s) beta_s ...
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.lmm | synthetic random-intercept fixture | lme4::lmer | fixed_effect_max_abs_delta | 0.0001614 | 0.02 | strict-practical | PASS | 426.8 |
