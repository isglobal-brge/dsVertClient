# Contingency tests validation (K=2)
...
| s2  | s2     |  80 | patient_id, bp_grp, diabetes |
...
#> [ds.vertChisqCross] age_grp@s1 x diabetes@s2, session=285a6f45
#>   n[older,no] = 21
#>   n[older,yes] = 20
#>   n[younger,no] = 32
#>   n[younger,yes] = 7
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K=2 | ds.vert.chisq / ds.vert.fisher / ds.vert.chisq_cross | MASS::Pima.tr categorical fixture | chisq.test / fisher.test | max(count_or_chisq_delta) | 0 | 0 | strict-precise | PASS | 3.1 |
