...
| s2  | s2     |  50 | patient_id, x2         |
| s3  | s3     |  50 | patient_id, cluster, y |
...
#> Server 's3': 50 of 50 records matched (100.0%)
...
#> Observations: 50, Variables: 2, Partitions: 3
...
#> 
#> [Phase 3] Ring127 Beaver Gradient (K=3 servers, family=binomial)...
#> 
#> [Phase 3] K>=3 ring127 DCF + Beaver L-BFGS (family=binomial, n=50, intervals=100, lambda=0.0e+00)
#>   [Input Sharing] Sharing features+y with DCF parties...
#>   [Input Sharing] Complete (p_total=2, 0.2s)
#>   [DCF] Server s2 generating keys (n=50, 100 intervals)...
#>   [DCF] Keys distributed (75.8s)
#>     [1.1] Computing eta shares...
#>     [1.2] DCF wide spline...
#>     [1.3] Beaver gradient...
#>   Iter 1: ||grad||=0.1417, step=0.30, diff=3.67e-02, theta=[-0.037, 0.018] (4.4s)
#>     [2.1] Computing eta shares...
#>     [2.2] DCF wide spline...
#>     [2.3] Beaver gradient...
#>   Iter 2: ||grad||=0.1310, step=1.00, diff=4.54e-01, theta=[-0.491, 0.225] (4.2s)
#>     [3.1] Computing eta shares...
#>     [3.2] DCF wide spline...
#>     [3.3] Beaver gradient...
#>   Iter 3: ||grad||=0.0078, step=1.00, diff=2.85e-02, theta=[-0.519, 0.236] (4.1s)
#>   Iter 4: ||grad||=0.0009, step=1.00, diff=3.53e-03, theta=[-0.523, 0.238] (4.2s)
#>   Iter 5: ||grad||=0.0000, step=1.00, diff=8.63e-05, theta=[-0.523, 0.238] (4.0s)
#>   Converged after 5 iterations (diff = 8.63e-05)
#>   [Ring63-DCF-Beaver] Converged after 5 iters (total 20.9s)
#>   [Deviance] Computing canonical deviance...
#>   [Deviance] = 65.2801
#> 
#> [Phase 5] Secure deviance (Beaver): 65.2801
#> 
...
#>   Iter 5: ||grad||=0.0000, step=1.00, diff=8.63e-05, theta=[-0.523, 0.238] (4.0s)
#>   Converged after 5 iterations (diff = 8.63e-05)
#>   [Ring63-DCF-Beaver] Converged after 5 iters (total 20.5s)
#> 
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.glmm(method=‘pql’) | synthetic mixed binomial random-intercept fixture | MASS::glmmPQL | fixed_effect_max_abs_delta_and_pql_quality | 0.0005547 | 0.005 | strict-pql | PASS | 542.0 |
| K\>=3 | ds.vert.glmm(method=‘laplace’) | synthetic mixed binomial random-intercept fixture | lme4::glmer | max_fixed_effect_or_sigma_b2_abs_delta | 0.0407200 | 0.060 | laplace-practical | PASS | 323.4 |
