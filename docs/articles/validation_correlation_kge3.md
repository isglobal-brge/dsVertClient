...
| s3  | s3     |  60 | patient_id, npreg, glu, bp |
...
#> === Ring63 Correlation (p=7, 3 servers) ===
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.cor | MASS::Pima.tr fixture | stats::cor | correlation_max_abs_delta | 1.24e-05 | 1e-04 | strict-practical | PASS | 3.6 |
