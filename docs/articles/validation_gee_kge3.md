...
| s3  | s3     |  60 | patient_id, npreg, glu, bp, diabetes, cluster |
...
#>   Iter 13: ||grad||=0.0002, step=1.00, diff=6.49e-05, theta=[0.000, 0.342] (0.3s)
#>   Converged after 13 iterations (diff = 6.49e-05)
#>   [Ring63-DCF-Beaver] Converged after 13 iters (total 3.3s)
...
#>   bmi                 0.0034     0.0098      0.350   0.726403
#>   ped                 0.3141     0.1181      2.660   0.007822 **
#>   skin                0.0070     0.0061      1.136   0.255896
#>   npreg               0.0108     0.0199      0.543   0.586959
#>   glu                 0.0047     0.0015      3.075   0.002103 **
#>   bp                  0.0014     0.0045      0.317   0.751515
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.gee(corstr=‘independence’) | MASS::Pima.tr clustered fixture | geepack::geeglm | coef_max_abs_delta | 6e-05 | 0.01 | strict-practical | PASS | 13.9 |
