# Descriptive statistics validation (K\>=3)
...
|:---|:---|:---|:---|:---|---:|---:|:---|:---|---:|
| K\>=3 | ds.vert.desc | MASS::Pima.tr fixture | central mean/sd | max(mean_sd_abs_delta) | 0 | 0 | strict-precise | PASS | 2 |
