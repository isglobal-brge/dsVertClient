...
Inter-server disclosure: the DCF peer learns the cluster membership
(same class as Cox event-time ordering). Absolute cluster sizes are
revealed; individual observations are not.
