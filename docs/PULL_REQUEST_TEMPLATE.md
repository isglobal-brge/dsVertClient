...
Any new exported `ds.vert*` function is added to the appropriate
`reference:` section in `_pkgdown.yml` (pkgdown errors hard if the index
is incomplete).
...
|----|----|----|----|
|  | \<e.g. 3.18e-04\> | \<[`stats::glm`](https://rdrr.io/r/stats/glm.html)\> | STRICT / SUB-NOISE / PRACTICAL |
