...
| Cox PH | [`ds.vertCox()`](https://isglobal-brge.github.io/dsVertClient/reference/ds.vertCox.md) / [`ds.vertCoxProfileNonDisclosive()`](https://isglobal-brge.github.io/dsVertClient/reference/ds.vertCoxProfileNonDisclosive.md); discrete-time ND route also available | same profile ND route | `legacy_rank`, `ds.vertCox.k3()` removed |
