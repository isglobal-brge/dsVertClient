...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{PCA validation}
...
PCA is computed from the validated correlation matrix, not from patient-level scores.

## Mathematical target

The target is the eigendecomposition R = V Lambda V^T. The validation compares eigenvalues and sign-aligned loadings.
...
```{r evidence}
rows <- run_validation("pca", force = force_run, trace = TRUE)
