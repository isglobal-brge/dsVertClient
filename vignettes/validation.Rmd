...
```{r ground-truth}
extdata <- system.file("extdata", package = "dsVertClient")
full <- merge(merge(
  read.csv(file.path(extdata, "pima_server1.csv")),
  read.csv(file.path(extdata, "pima_server2.csv")), by = "patient_id"),
  read.csv(file.path(extdata, "pima_server3.csv")), by = "patient_id")
