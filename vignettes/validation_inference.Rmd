...
Inference helpers post-process the beta, covariance, deviance, and degrees of freedom already returned by ds.vert.glm.
...
Centralized reference: Manual algebra on ds.vert.glm output.
...
```{r evidence}
rows <- run_validation("inference", force = force_run, trace = TRUE)
